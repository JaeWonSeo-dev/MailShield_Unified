...
function analyzeMailContext(context) {
  ...
  return {
    ...
    rule_features: {
      ...
      link_lure_score: linkLureScore,
      malware_lure_score: malwareLureScore,
      has_http_url: hasHttpUrl,
      has_suspicious_url: hasSuspiciousUrl,
      has_external_url: hasExternalUrl,
      suspicious_file_link: suspiciousFileLink,
      has_shortened_url: hasShortenedUrl,
      long_url_path: longUrlPath,
      sender_domain_mismatch: senderDomainMismatch,
      combo_risk: comboRisk,
      link_only_lure: linkOnlyLure,
      rule_risk_score: Number(score.toFixed(2)),
    },
  };
}
